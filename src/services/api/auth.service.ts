...
import { IAuth } from '@chandrashekar2001/ecommerce-shared'
...
class AuthService {
  ...
  // this.axiosService.axios is used to access routes which are not protected and do not require jwt token
